  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 max-w-lg mx-auto w-full">
      ...
      <motion.div
        ...
        className="w-full bg-[#240c0a]/90 rounded-3xl p-6 sm:p-9 border border-[#ff9100]/35 shadow-[0_10px_35px_rgba(0,0,0,0.6)] relative overflow-hidden"
      >
        {/* Top Glow Highlight */}
        ...
        <div className="text-center space-y-2 mb-7">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#3d1808]/80 border border-[#ff9100]/40 text-[#ff9100] text-xs font-mono font-bold">
          ...
          <p className="text-xs sm:text-sm text-[#fff1d1]/70 max-w-sm mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-bold uppercase tracking-wider text-[#fff1d1] flex items-center gap-1.5">
              <User className="w-3.5 h-3.5 text-[#00b7cd]" />
              <span>Full Name</span>
            </label>
            <input
              type="text"
              ...
              className="w-full px-4 py-3 rounded-xl bg-[#160706] border border-[#df301c]/40 focus:border-[#ff9100] focus:ring-2 focus:ring-[#ff9100]/20 outline-none text-white placeholder-[#fff1d1]/30 text-sm font-semibold transition-all"
            />
          </div>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-bold uppercase tracking-wider text-[#fff1d1] flex items-center gap-1.5">
              <Hash className="w-3.5 h-3.5 text-[#ff9100]" />
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-[#160706] border border-[#df301c]/40 focus:border-[#00b7cd] focus:ring-2 focus:ring-[#00b7cd]/20 outline-none text-white placeholder-[#fff1d1]/30 text-sm font-mono font-bold uppercase tracking-wider transition-all"
            />
          </div>
          ...
          <button
            ...
            className="w-full mt-3 flex items-center justify-center gap-2.5 py-3.5 px-6 rounded-xl bg-gradient-to-r from-[#ff9100] via-[#ffa726] to-[#fff1d1] hover:from-[#ffa726] hover:to-[#fff8e6] text-[#160706] font-black text-sm transition-all shadow-[0_0_20px_rgba(255,145,0,0.35)] active:scale-[0.98] disabled:opacity-50"
          >
            {submitting ? (
